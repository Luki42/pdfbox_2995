...
public final class PDAcroForm implements COSObjectable {
    ...
    public void importFDF(FDFDocument fdf) throws IOException {
        ...
        try {
            ...
            if (fields != null) {
                if (CallChecker.beforeDeref(fields, void.class, 116, 3704, 3709)) {
    ...
    public void flatten() throws IOException {
        ...
        try {
            ...
            for (PDField field : getFieldTree()) {
                for (PDAnnotationWidget widget : CallChecker.isCalled(((PDTerminalField) (field)), PDTerminalField.class, 179, 5679, 5702).getWidgets()) {
